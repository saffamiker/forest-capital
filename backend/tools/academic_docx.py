...
_BRIEF_FIGURES: tuple[tuple[str, str, str], ...] = (
    (
        ...
        "Generated by AnalyticsDesk portfolio intelligence platform "
        "using historical S&P 500, investment-grade bond, and "
        "high-yield bond return data. Out-of-sample window begins "
        "January 2022. Transaction costs of 15 basis points applied "
    ...
    (
        ...
        "May 2026",
        "Blue series = equity vs investment-grade bonds. Green series "
        "= equity vs high-yield bonds. Dashed vertical line marks "
        "January 2022 correlation regime break. Pre-2022 equity-IG "
        "mean = {{PRE_2022_EQ_IG_CORR}}; post-2022 mean = "
        "{{POST_2022_EQ_IG_CORR}}. Data hash: {{DATA_HASH}}.",
        "rolling_correlation",
    ),
    (
        "Risk-Return Efficient Frontier, Full Sample (July 2002 "
        "Through May 2026)",
        "Each point represents one of {{N_STRATEGIES}} strategies "
        "evaluated over the full study period. Annualized volatility "
        "on x-axis; annualized return on y-axis. Benchmark (S&P 500) "
        "shown in orange; regime-conditional blend shown in green. "
        "Data hash: {{DATA_HASH}}.",
        "efficient_frontier",
    ),
    (
        "Out-of-Sample Sharpe Ratio Comparison, {{OOS_WINDOW}}",
        "Out-of-sample window begins January 2022, after model "
        "training cutoff. Blend OOS Sharpe = {{OOS_SHARPE_BLEND}}; "
        "Benchmark OOS Sharpe = {{OOS_SHARPE_BENCHMARK}}. Data hash: "
        "{{DATA_HASH}}.",
        "strategy_comparison",
    ),
)
