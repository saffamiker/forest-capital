...
def academic_review_arbiter_evaluator_prompt() -> str:
    ...
    return (
        ...
        "present? STRICT scoring — 5 sections present scores 10, 4 "
        "sections scores 3, 3 or fewer scores 0. A missing Section 5 "
        "(Overall Academic Readiness) is the canonical truncation "
        "symptom — the arbiter must regenerate when it lands. UAT issues "
        "#128 and #125 traced back to the previous lenient scoring (4 "
        "sections at 8/10) clearing the harness threshold and accepting "
        "the truncated verdict.\n"
        ...
        "substantive and honest, not generic encouragement? If Section 5 "
        "is missing, score this 0 — there is no paragraph to assess.\n\n"
        "WEIGHTS for the overall score: all_sections_present 0.35, "
        "all_sections_rated 0.20, investigation_specificity 0.20, "
        "synthesis_quality 0.10, overall_readiness_substance 0.15.\n\n"
